...
// +kubebuilder:webhook:path=/mutate-trait-ghostbaby-com-v1-cfstrait,mutating=true,failurePolicy=fail,groups=trait.ghostbaby.com,resources=cfstraits,verbs=create;update,versions=v1,name=mcfstrait.kb.io
...
// +kubebuilder:webhook:verbs=create;update,path=/validate-trait-ghostbaby-com-v1-cfstrait,mutating=false,failurePolicy=fail,groups=trait.ghostbaby.com,resources=cfstraits,versions=v1,name=vcfstrait.kb.io
